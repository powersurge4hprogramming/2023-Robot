...
public final class Constants {
  ...
  public static final class VisionConstants {
    ...
    public static final Transform3d kRobotToCamera = new Transform3d(new Translation3d(0.5, 0.0, 0.5), new Rotation3d(0,0,0)); // TODO Cam mounted facing forward, half a meter forward of center, half a meter up from center.
